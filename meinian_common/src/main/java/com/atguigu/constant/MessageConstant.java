...
public class MessageConstant {
    ...
    public static final String UPDATE_TRAVELITEM_FAIL = "编辑自由行失败";
    public static final String UPDATE_TRAVELITEM_SUCCESS = "编辑自由行成功";
    ...
    public static final String DELETE_TRAVELGROUP_SUCCESS = "删跟报团游成功";
    public static final String QUERY_TRAVELGROUP_SUCCESS = "查询跟团游成功";
    public static final String QUERY_TRAVELGROUP_FAIL = "查询跟团游失败";
    public static final String UPDATE_TRAVELGROUP_FAIL = "编辑跟团游失败";
    public static final String UPDATE_TRAVELGROUP_SUCCESS = "编辑跟团游成功";
    ...
    public static final String UPDATE_MEMBER_FAIL = "编辑会员失败";
    public static final String UPDATE_MEMBER_SUCCESS = "编辑会员成功";
    ...
    public static final String SELECTED_DATE_CANNOT_ORDER = "所选日期还未开放进行旅游预约";
