...
public class QiniuUtils {
    ...
    public  static String accessKey = "_S8wSrOiFKYKlEMR8rbgW0oJOdZ-foEyZPpuhrHA";
    public  static String secretKey = "FOzywNY_6Wh3EZYd2LoZJ4cGmeEgfdEP2qo4gXu0";
    public  static String bucket = "meinian-yu";
